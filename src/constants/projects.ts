...
export const CASE_STUDIES: CaseStudyData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        display: 'index',
        gallery: [
          // announcement thread — continuous, 1 → 14
          '/content/monolith/announcement-1.webp',
          '/content/monolith/monolith-announce-2.webp',
          '/content/monolith/announcement-3.webp',
          '/content/monolith/announcement-4.webp',
          '/content/monolith/monolith-announce-5.webp',
          '/content/monolith/announcement-6.webp',
          '/content/monolith/announcement-7.webp',
          '/content/monolith/announcement-8.webp',
          '/content/monolith/announcement-9.webp',
          '/content/monolith/announcement-10.webp',
          '/content/monolith/announcement-11.webp',
          '/content/monolith/announcement-12.webp',
          '/content/monolith/vibecoding-13.webp',
          '/content/monolith/vibecoding-14.webp',
          // FAQ thread — continuous
          '/content/monolith/faq-1.webp',
          '/content/monolith/monolith-faq-2.webp',
          '/content/monolith/faq-3.webp',
          '/content/monolith/faq-4.webp',
          '/content/monolith/faq-5.webp',
          '/content/monolith/faq-6.webp',
          // milestones & notices
          '/content/monolith/faq-1-1.webp',
          '/content/monolith/faq-1-2.webp',
          // event content
          '/content/monolith/share-thumbnail.webp',
          '/content/monolith/content-1.webp',
          '/content/monolith/monolith-content-2.webp',
          '/content/monolith/todo-1.webp',
          // workshops & spaces
          ...
          // post-event & vibecoding recaps
          '/content/monolith/post-content.webp',
          '/content/monolith/vibecoding-cover.webp',
          '/content/monolith/monolith-vibecoding-2.webp',
          '/content/monolith/vibecoding-3.webp',
          '/content/monolith/vibecoding-4.webp',
          '/content/monolith/monolith-vibecoding-5.webp',
          '/content/monolith/vibecoding-6.webp',
          '/content/monolith/vibecoding-7.webp',
          '/content/monolith/vibecoding-8.webp',
          '/content/monolith/vibecoding-9.webp',
          '/content/monolith/vibecoding-10.webp',
          '/content/monolith/vibecoding-11.webp',
          '/content/monolith/vibecoding-12.webp',
        ],
      },
      {
        ...
        gallery: [
          ...
          '/content/seeker/submission-alert.webp',
          ...
          '/content/seeker/new-prize.webp',
          '/content/seeker/saga-prize.webp',
          '/content/seeker/categories.webp',
          '/content/seeker/hackathon-duration.webp',
          '/content/seeker/10-hours.webp',
          '/content/seeker/reminder.webp',
          '/content/seeker/showus.webp',
          '/content/seeker/makebreak.webp',
          '/content/seeker/greatness.webp',
          '/content/seeker/solblaze.webp',
          '/content/seeker/hylo.webp',
          '/content/seeker/stake-pool.webp',
          '/content/seeker/extension.webp',
          '/content/seeker/teams-of-the-week.webp',
          '/content/seeker/announcement-2.webp',
          '/content/seeker/faq-3.webp',
          '/content/seeker/tips-1.webp',
          '/content/seeker/ty-sponsors-1.webp',
          '/content/seeker/ty-sponsors-2.webp',
    ...
    category: 'brand',
    description: '2+ years content lead. Created hundreds of content pieces.\nKept things rad.',
  ...
  },
  {
    ...
    gallery: [],
    previewGallery: [
      '/content/hydex-brand/deck-01.webp',
    ...
    sections: [
      {
        title: 'Hydex',
        description: 'Brand pitch deck for the core Hydex protocol.',
        layout: 'deck',
        gallery: [
          '/content/hydex-brand/deck-01.webp',
          '/content/hydex-brand/deck-02.webp',
          ...
          '/content/hydex-brand/deck-07.webp',
          '/content/hydex-brand/deck-08.webp',
          '/content/hydex-brand/deck-09.webp',
          '/content/hydex-brand/deck-10.webp',
          '/content/hydex-brand/deck-11.webp',
        ],
      },
      {
        title: 'Hydex Router',
        description: 'Follow-up deck for the Router product with refined data visualization and narrative.',
        layout: 'deck',
        gallery: [
  ...
  },
  {
    ...
    color: '#F97316',
    gallery: [
      '/content/whatsfordinner/home-1.webp',
      '/content/whatsfordinner/home-2.webp',
      '/content/whatsfordinner/home-3.webp',
      '/content/whatsfordinner/home-4.webp',
      '/content/whatsfordinner/home-5.webp',
      '/content/whatsfordinner/home-6.webp',
      '/content/whatsfordinner/home-7.webp',
      '/content/whatsfordinner/home-8.webp',
    ...
    sections: [
      {
        title: 'Landing Page',
        description: 'Warm minimal design, orange on cream. The hero doubles as the product: pick how you eat, set your calories, and generate a day before signing up for anything.',
        gallery: [
          '/content/whatsfordinner/home-1.webp',
          '/content/whatsfordinner/home-2.webp',
          '/content/whatsfordinner/home-3.webp',
      ...
      },
      {
        ...
        description: 'The weekly plan: day-by-day meals with calorie counts and cook times, beside a grocery list grouped by aisle with an estimated cost. Regenerates every Sunday.',
        gallery: [
          '/content/whatsfordinner/preview-1.webp',
        ],
      },
