...
const SLIDERS: SliderConfig[] = [
  ...
  },
  {
    ...
    morph(cv, t) {
      ...
      // Colors: vibrant → lighter mid (visible on mid bg) → muted monochrome at serious end
      const colors = [
        { r: [239, 180, 150, 110, 71], g: [68, 80, 110, 100, 85], b: [68, 90, 130, 120, 105] },
        { r: [59, 100, 140, 120, 100], g: [130, 130, 150, 140, 116], b: [246, 200, 180, 150, 137] },
        { r: [16, 80, 130, 110, 100], g: [185, 160, 155, 140, 116], b: [129, 120, 140, 130, 137] },
        { r: [245, 200, 170, 130, 100], g: [158, 140, 140, 130, 116], b: [11, 50, 110, 120, 137] },
      ]
