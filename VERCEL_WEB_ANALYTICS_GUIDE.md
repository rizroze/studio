...
### For Next.js, Next.js App Router, Remix, Create React App, Nuxt, Vue, Astro, and SvelteKit
...
#### Legacy Astro Configuration (versions before 1.4.0)

The `Analytics` component is available in version `@vercel/analytics@1.4.0` and later. If you are using an earlier version, you must configure the `webAnalytics` property of the Vercel adapter in your `astro.config.mjs` file as shown in the code below.
